        ...
        <>
            <Nav className='menu'>
                <div onClick={() => setSideBarOn(false)} className='nav-item nav-quit'>
                    <CloseButton onClick={() => setSideBarOn(false)} className='nav-quit' />

                </div>
                <div className='nav-content'>
                    <StyledLink to='/myquestion'>
                        <li onClick={() => setSideBarOn(false)} className='nav-item nav-hover'>나의 질문</li>
                    </StyledLink>
                    <StyledLink to='/applymentor'>
                        <li onClick={() => setSideBarOn(false)} className='nav-item nav-hover'>멘토 지원하기</li>
                    </StyledLink>

                    <StyledLink to='/mypage'>
                        <li onClick={() => setSideBarOn(false)} className='nav-item nav-hover'>
                            마이페이지
                 </li>
                    </StyledLink>
                    <StyledLink to='/'>
